...
This years informatiCup challenge was to classify GitHub repos (repositories) automatically based on given class descriptions and sample data.
...
\todo[inline]{{[}accuracy from single models{]}{[}accuracy from ensembled models{]}}
