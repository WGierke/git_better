...
\todo[inline]{Better without language features}


\todo[inline]{accuracy from single models}
\todo[inline]{aaccuracy from ensembled models}
...
\todo[inline]{Include images with additional validation data}
...
We cloned each repository and his wiki, which is also a git repository, locally to retrieve the data we need.
...
\newpage
\section{\\Evaluation of commit message classifier} \label{App:AppendixB}
