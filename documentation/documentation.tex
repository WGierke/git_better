...
\begin{center}
  \vskip.2in
  \large  Submission for informatiCup2017 \ldots
  \vskip1in
  \Large Hasso Plattner Institute (University of Potsdam)
  \vskip1.5in
  \emph{\huge GitHub Repository Classifier}
\end{center}
...
\begin{minipage}{.25\textwidth}
  \begin{flushleft}
    \bfseries\large Willi Gierke
  \end{flushleft}
\end{minipage}
\hskip.4\textwidth
\begin{minipage}{.25\textwidth}
  \begin{flushleft}
    \bfseries\large Sebastian Bischoff
  \end{flushleft}
\end{minipage}
...
\hline
size¹ & watchers¹ & size¹xwatchers¹ & size² & watchers² \\ \hline
2 & 5 & 10 & 4 & 25 \\ \hline
